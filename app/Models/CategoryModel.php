...
class CategoryModel extends Model
{
    ...
    protected $allowedFields    = ['name', 'active', 'slug', 'image'];
    ...
    protected $validationRules = [
        'name'         => 'required|min_length[4]|max_length[50]|is_unique[categories.name]',
    ...
    /**
     * 
     * @uso Controller Categoryes no método search com o autocomplete
     *
     * author: Marcelino
     * 
     * @param string $term
