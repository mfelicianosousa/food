/**
*
* Formulário de Exclusão de Medidas
*
*/
    ...
    <div class="col-lg-8 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php echo form_open("adm/measurements/excluir/$measure->id"); ?>
                    
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <strong>Atenção! </strong>Tem certeza da exclusão do extra, <strong> <?php echo esc($measure->name); ?>?</strong>
                    ...
                    <!-- botão voltar -->
                    <a href="<?php echo site_url("adm/measurements/show/$measure->id"); ?>" class="btn btn-light text-dark btn-sm">
