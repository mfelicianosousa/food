/**
*
* Formulário de Exclusão (Forma de Pagamento)
*
*/
    ...
    <div class="col-lg-8 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php echo form_open("adm/payment/delete/$paymentMethod->id"); ?>
                    
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <strong>Atenção! </strong>Tem certeza da exclusão da forma de pagamento, <strong> <?php echo esc($paymentMethod->name); ?>?</strong>
                    ...
                    <!-- botão voltar -->
                    <a href="<?php echo site_url("adm/payment/show/$paymentMethod->id"); ?>" class="btn btn-light text-dark btn-sm">
