...
<head>
  ...
  <link rel="stylesheet" href="<?php echo site_url('adm/'); ?>vendors/datatables.net-bs4/dataTables.bootstrap4.css">
...
<body>
  ...
  <div class="container-fluid page-body-wrapper">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <ul class="nav">
        <li class="nav-item">
          <a class="nav-link" href="<?php echo site_url('adm/home'); ?>">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo site_url('adm/categories'); ?>">
  ...
  <script src="<?php echo site_url('adm/'); ?>vendors/chart.js/Chart.min.js"></script>
  <script src="<?php echo site_url('adm/'); ?>vendors/datatables.net/jquery.dataTables.js"></script>
  <script src="<?php echo site_url('adm/'); ?>vendors/datatables.net-bs4/dataTables.bootstrap4.js"></script>
  ...
  <script src="<?php echo site_url('adm/'); ?>js/dashboard.js"></script>
  <script src="<?php echo site_url('adm/'); ?>js/data-table.js"></script>
  <script src="<?php echo site_url('adm/'); ?>js/jquery.dataTables.js"></script>
  <script src="<?php echo site_url('adm/'); ?>js/dataTables.bootstrap4.js"></script>
  <!-- End custom js for this page-->
  <script src="<?php echo site_url('adm/'); ?>js/jquery.cookie.js" type="text/javascript"></script>
